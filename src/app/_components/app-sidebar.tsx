...
import AppTitle from "@/app/_components/app-title";
import { AppSidebarSessionProvider } from "@/app/_components/app-sidebar-context";
...
export function AppSidebar({
  ...
  return (
    <AppSidebarSessionProvider session={session ?? null}>
